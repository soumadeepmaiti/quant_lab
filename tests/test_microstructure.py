...
from quantlab.microstructure.impact import square_root_impact
from quantlab.microstructure.lob import (
    LimitOrderBook,
    initialize_book,
    load_real_book_from_polygon,
)
...
class TestMarketImpact:
    ...
    def test_square_root_impact_calculation(self, market_data):
        ...
        impact = square_root_impact(q, v, sigma, eta=0.025)
...
class TestOrderFlowSignals:
    ...
    def test_ofi_positive_bid_size_increase(self):
        ...
        before = {'bid_size': 1000, 'ask_size': 1000, 'best_bid': 100.0, 'best_ask': 100.5}
        after = {'bid_size': 1500, 'ask_size': 1000, 'best_bid': 100.0, 'best_ask': 100.5}
    ...
    def test_ofi_negative_ask_size_increase(self):
        ...
        before = {'bid_size': 1000, 'ask_size': 1000, 'best_bid': 100.0, 'best_ask': 100.5}
        after = {'bid_size': 1000, 'ask_size': 1500, 'best_bid': 100.0, 'best_ask': 100.5}
    ...
    def test_ofi_calculation_zero_no_change(self):
        ...
        before = {'bid_size': 1000, 'ask_size': 1000, 'best_bid': 100.0, 'best_ask': 100.5}
        after = {'bid_size': 1000, 'ask_size': 1000, 'best_bid': 100.0, 'best_ask': 100.5}
